    ...
    <div className="min-h-screen">
      ...
      <section className="relative pt-36 pb-24 lg:pt-48 lg:pb-32 px-6 lg:px-16 3xl:px-32 bg-gradient-to-br from-navy via-navy-mid to-navy-light overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center gap-3.5 mb-6">
            ...
            <span className="text-sm uppercase tracking-[0.35em] text-gold">Plan Ahead</span>
            <span className="w-10 h-[1.5px] bg-gold" />
          </div>
        ...
        <div className="container-wide">
          <div className="mb-12 reveal opacity-0 translate-y-9 transition-all duration-700">
            <div className="flex items-center gap-3.5 mb-5">
              ...
              <span className="text-sm uppercase tracking-[0.35em] text-gold">This Month</span>
            </div>
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-16 3xl:px-32 bg-navy-mid border-t border-border">
        <div className="container-wide">
          <div className="mb-12 reveal opacity-0 translate-y-9 transition-all duration-700">
            <div className="flex items-center gap-3.5 mb-5">
              <span className="w-8 h-px bg-gold" />
              <span className="text-sm uppercase tracking-[0.35em] text-gold">Full Schedule</span>
            </div>
            <h2 className="font-bebas text-[clamp(2.75rem,5vw,4rem)] leading-[0.95] text-white">
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-16 3xl:px-32 bg-navy border-t border-border">
        <div className="max-w-3xl mx-auto text-center reveal opacity-0 translate-y-9 transition-all duration-700">
          <h2 className="font-bebas text-[clamp(3rem,6vw,4.5rem)] leading-[0.95] text-white mb-6">
