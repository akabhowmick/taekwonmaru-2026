    ...
    <div className="min-h-screen">
      ...
      <section className="relative pt-36 pb-24 lg:pt-48 lg:pb-32 px-6 lg:px-16 3xl:px-32 bg-gradient-to-br from-navy via-navy-mid to-navy-light overflow-hidden">
        ...
        <div className="relative z-10 container-wide grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="hidden md:block bg-navy/80 backdrop-blur-sm border border-border p-8">
            <h2 className="font-bebas text-2xl text-white mb-1">Book Your Trial</h2>
            <p className="text-sm text-muted mb-6">$10 trial · Any program · All ages</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label
                    htmlFor="hero_student_name"
                    className="block text-sm uppercase tracking-wider text-gold mb-1.5"
                  >
                    Student Name *
                  </label>
                  <input
                    type="text"
                    id="hero_student_name"
                    name="student_name"
                    required
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label
                    htmlFor="hero_class_interest"
                    className="block text-sm uppercase tracking-wider text-gold mb-1.5"
                  >
                    Class *
                  </label>
                  <select
                    id="hero_class_interest"
                    name="class_interest"
                    required
                    className="w-full bg-navy border border-border text-white px-3 py-2.5 text-sm focus:outline-none focus:border-gold transition-colors"
                  >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  >
                    Parent Name
                    <span className="text-white text-sm ml-1">(if under 18)</span>
                  </label>
                  <input
                    type="text"
                    id="parent_name"
